...
class SelectSerializerMixin:
    """
    Allows the view to work with two serializers.

    One for reading data and another for writing data. It gives the view the
    `_read_serializer_class` if the request is a write request (post, put,
    patch), otherwise the `_read_serializer_class`.
